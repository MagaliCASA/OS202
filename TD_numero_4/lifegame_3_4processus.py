...
if __name__ == '__main__':
    ...
    if myRank == 0:
        ...
        local_grid.cells = grid.cells[ordonnees_loc-2:,absisses_loc-2:]
    ...
    while True:
        ...
        if myRank == 2 : 
            ...
            comm.send((local_grid.cells[1,:],local_grid.cells[-2,:]),dest=0)
            ghost2_low,ghost2_high = comm.recv(source=0) 
        ...
        if myRank == 3 : 
            comm.send((local_grid.cells[:,1],local_grid.cells[:,-2]),dest=0)
            ghost3_right,ghost3_left = comm.recv(source=0) 
        ...
        if myRank == 0 : 
            ...
            grid.cells[ordonnees_loc:,absisses_loc:] = local_grid.cells[1:-1,1:-1]
            t4 = time.time()
            appli.draw()
            t3 = time.time()
